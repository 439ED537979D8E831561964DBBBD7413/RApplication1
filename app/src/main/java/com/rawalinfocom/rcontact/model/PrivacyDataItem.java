...
public class PrivacyDataItem {
    ...
    private ArrayList<PrivacyEntityItem> pbRating;
    ...
    public ArrayList<PrivacyEntityItem> getPbRating() {
        return pbRating;
    }

    public void setPbRating(ArrayList<PrivacyEntityItem> pbRating) {
