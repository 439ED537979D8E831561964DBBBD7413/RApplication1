...
public class AppLanguageListAdapter extends RecyclerView.Adapter<AppLanguageListAdapter.CountryViewHolder> {

    private ArrayList<AppLanguage> appLanguageArrayList;
    private String selectedLanguage = "", selectedLanguageType = "";

    public AppLanguageListAdapter(ArrayList<AppLanguage> appLanguageArrayList) {
    ...
    public void onBindViewHolder(CountryViewHolder holder, int position) {
        ...
        if (appLanguage.getIsSelected()) {
            selectedLanguage = appLanguage.getLanguageName();
            selectedLanguageType = appLanguage.getLanguageType();
    ...
    public String getSelectedLanguageType() {
        return this.selectedLanguageType;
    }
    ...
    class CountryViewHolder extends RecyclerView.ViewHolder {
        ...
        CountryViewHolder(View itemView) {
            ...
            checkboxLanguage.setVisibility(View.VISIBLE);
        }
    }
}
