...
//        Log.v(">SHA > ", Utils.getCertificateSHA1Fingerprint(MainActivity.this));
    ...
    private void create_file_in_folder(final DriveId driveId) {
        ...
        Drive.DriveApi.newDriveContents(mGoogleApiClient).setResultCallback(new ResultCallback<DriveApi.DriveContentsResult>() {
            ...
            public void onResult(@NonNull DriveApi.DriveContentsResult driveContentsResult) {
                ...
                Toast.makeText(UploadActivity.this, "Uploading to drive. If you didn't fucked up something like usual you should see it there", Toast.LENGTH_LONG).show();
    ...
    public void writeToFile(String fileName, String body) {
        ...
        try {
            ...
            fos.close();
            Toast.makeText(UploadActivity.this, "File created ok! Let me give you a fucking congratulations!", Toast.LENGTH_LONG).show();
        } catch (IOException e) {
