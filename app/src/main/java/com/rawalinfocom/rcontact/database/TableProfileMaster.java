...
//            values.put(COLUMN_PM_PHONETIC_FIRST_NAME, arrayListUserProfile.get(i).getPmPhoneticFirsgetPmLastNametName());
    ...
    public UserProfile getProfileFromCloudPmId(int cloudPmd) {
        ...
        try {
            ...
            Cursor cursor = db.query(TABLE_RC_PROFILE_MASTER, new String[]{COLUMN_PM_RAW_ID,
                    COLUMN_PM_FIRST_NAME, COLUMN_PM_LAST_NAME, COLUMN_PM_PROFILE_IMAGE, COLUMN_PM_RCP_ID,
                    COLUMN_PM_GENDER, COLUMN_PM_GENDER_PRIVACY, COLUMN_PM_PROFILE_RATING,
                    COLUMN_PM_PROFILE_RATE_USER, COLUMN_PM_IS_FAVOURITE, COLUMN_PM_NOSQL_MASTER_ID}, COLUMN_PM_RCP_ID
