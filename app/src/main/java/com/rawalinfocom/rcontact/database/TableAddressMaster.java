...
public class TableAddressMaster {
    ...
    private static final String COLUMN_AM_CITY_ID = "am_city_id";
    private static final String COLUMN_AM_COUNTRY = "am_country";
    private static final String COLUMN_AM_COUNTRY_ID = "am_country_id";
    ...
    private static final String COLUMN_AM_STATE_ID = "am_state_id";
