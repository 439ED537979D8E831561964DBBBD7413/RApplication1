...
public class FinestWebViewActivity extends AppCompatActivity
    ...
    protected void layoutViews() {
        ...
        { // Icons
            updateIcon(close, rtl ? R.drawable.more_vector : R.drawable.back_vector);
            updateIcon(back, R.drawable.back_vector);
            updateIcon(forward, R.drawable.forward_vector);
            updateIcon(more, rtl ? R.drawable.close_vector : R.drawable.more_vector);
        }
...
//      menuShareVia.setVisibility(showMenuShareVia ? View.VISIBLE : View.GONE);
            menuShareVia.setVisibility(View.GONE);
