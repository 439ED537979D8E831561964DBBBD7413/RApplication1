 ...
 * <p>
 * A class for customised view for Progress Dialog Wheel
 */
...
public class ProgressWheel extends View {
    ...
    private void setupBounds(int layout_width, int layout_height) {
        ...
        if (!fillRadius) {
            ...
            circleBounds = new RectF(xOffset + barWidth, yOffset + barWidth, xOffset +
    ...
    private void parseAttributes(TypedArray a) {
        ...
        float baseSpinSpeed = a.getFloat(R.styleable.ProgressWheel_matProg_spinSpeed, spinSpeed /
                360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.ProgressWheel_matProg_barSpinCycleTime, (int)
                barSpinCycleTime);
    ...
    private void updateBarLength(long deltaTimeInMilliSeconds) {
        if (pausedTimeWithoutGrowing >= pauseGrowingTime) {
            ...
            float distance = (float) Math.cos((timeStartGrowing / barSpinCycleTime + 1) * Math
                    .PI) / 2 + 0.5f;
