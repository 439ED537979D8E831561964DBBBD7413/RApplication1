...
public class AnimateHorizontalProgressBar extends ProgressBar {
    ...
    public AnimateHorizontalProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        int progressColor = ta.getColor(R.styleable
                .AnimateHorizontalProgressBar_ahp_progressColor, DEFAULT_PROGRESS_COLOR);
        int backgroundColor = ta.getColor(R.styleable
                        .AnimateHorizontalProgressBar_ahp_backgroundColor,
                DEFAULT_PROGRESS_BACKGROUND_COLOR);
        int cornerRadius = ta.getDimensionPixelSize(R.styleable
                .AnimateHorizontalProgressBar_ahp_cornerRadius, DEFAULT_CORNER_RADIUS);
    ...
    private void setUpAnimator() {
        ...
        mProgressAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                AnimateHorizontalProgressBar.super.setProgress((Integer) animation
                        .getAnimatedValue());
            }
        });
