package com.rawalinfocom.rcontact.helper.recyclerviewfastscroller;
...
import com.rawalinfocom.rcontact.helper.recyclerviewfastscroller.sectionindicator.SectionIndicator;

/**
 * Defines a basic widget that will allow for fast scrolling a RecyclerView using the basic
 * paradigm of
 * a handle and a bar.
 * <p>
 * TODO: More specifics and better support for effectively extending this base class
 */
public abstract class AbsRecyclerViewFastScroller extends FrameLayout implements
     ...
     *      This could allow for some type checking on the section indicator wrt the adapter of
     *      the RecyclerView
    */
    ...
    /**
     * If I had my druthers, AbsRecyclerViewFastScroller would implement this as an interface,
     * but Android has made
    ...
    public AbsRecyclerViewFastScroller(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = getContext().getTheme().obtainStyledAttributes(attrs, STYLEABLE,
                0, 0);

        try {
            int layoutResource = attributes.getResourceId(R.styleable
                            .AbsRecyclerViewFastScroller_rfs_fast_scroller_layout,
                    getLayoutResourceId());
            ...
            Drawable barDrawable = attributes.getDrawable(R.styleable
                    .AbsRecyclerViewFastScroller_rfs_barBackground);
            int barColor = attributes.getColor(R.styleable
                    .AbsRecyclerViewFastScroller_rfs_barColor, Color.GRAY);
            applyCustomAttributesToView(mBar, barDrawable, barColor);

            Drawable handleDrawable = attributes.getDrawable(R.styleable
                    .AbsRecyclerViewFastScroller_rfs_handleBackground);
            int handleColor = attributes.getColor(R.styleable
                    .AbsRecyclerViewFastScroller_rfs_handleColor, Color.GRAY);
    ...
    /**
     * Provides the ability to programmatically set the background drawable of the fast
     * scroller's handle
     *
        ...
        if (mSectionIndicator != null) {
            ...
            if (mRecyclerView.getAdapter() instanceof SectionIndexer) {
                ...
                try {
                    ...
                    mSectionIndicator.setSection(sections[0]);
                }
            }
        }
    }
    ...
    /**
     * Classes that extend AbsFastScroller must implement their own {@link OnScrollListener} to
     * respond to scroll
        ...
        if (mOnScrollListener == null) {
            mOnScrollListener = new RecyclerView.OnScrollListener() {
                ...
                public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                    ...
                    ScrollProgressCalculator scrollProgressCalculator =
    ...
    /**
     * Sub classes have to override this method and create the ScrollProgressCalculator instance
     * in this method.
     */
